  ...
  const diseases = [
    {
      ...
      description:
        "Common skin condition treated with medication, chemical peels & laser therapy."
    },
    {
      name: "Eczema & Dermatitis",
      description:
        "Inflammatory skin disorders treated with topical & systemic therapy."
    },
    {
      name: "Psoriasis",
      description:
        "Autoimmune skin condition managed with phototherapy & biologics."
    },
    {
      name: "Vitiligo & Pigment Disorders",
      description:
        "Pigmentation disorders treated with medical & laser therapy."
    },
    {
      name: "Hair & Scalp Disorders",
      description:
        "Hair fall, alopecia & scalp infections treated with PRP & medications."
    },
    {
      name: "Skin Infections & Allergies",
      description:
        "Fungal, bacterial & allergic skin conditions treated accurately."
    },
    {
      name: "Skin Tumors & Cancers",
      description:
        "Detection & treatment of benign & malignant skin growths."
    }
  ];
      ...
      <div className="relative w-full h-[75vh] min-h-[550px] bg-[url('https://i.pinimg.com/1200x/79/ca/cd/79cacd36b206e0e26204d7a48e4f8dc1.jpg')] bg-cover bg-center bg-no-repeat flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-[2] text-center max-w-[1000px] px-8 animate-[slideInUp_1s_ease-out]">
          ...
          <p className="text-xl text-white/95 mb-8 max-w-[800px] mx-auto leading-[1.7] drop-shadow-[1px_1px_4px_rgba(0,0,0,0.3)] animate-[fadeIn_1s_ease-out_0.4s_backwards]">
            Expert care for skin, hair, nail & cosmetic conditions
          </p>
          <button
      ...
      <div className="max-w-[1400px] mx-auto mt-[100px] px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative animate-[slideInRight_1s_ease-out]">
            <img
              src="https://i.pinimg.com/736x/04/5c/ea/045cea2bd8c7c16355207abae164cedf.jpg"
      ...
      <div className="max-w-[1400px] mx-auto mt-[100px] mb-[60px] px-12">
        ...
        <div className="space-y-4">
          {diseases.map((disease, index) => (
            ...
            >
              <div
                className={`bg-white p-4 rounded-xl shadow-sm cursor-pointer transition-all duration-300 flex items-center gap-3 border-l-4 border-transparent hover:shadow-md hover:border-teal-500 hover:bg-teal-50 ${selectedDisease?.name === disease.name ? 'bg-teal-50 border-teal-500 shadow-md' : ''}`}
                onClick={() => toggleDisease(disease)}
              >
                <strong className="flex-1 text-slate-800 font-medium text-base">
                  {disease.name}
                </strong>
                <span className={`text-xl font-light text-teal-500 transition-transform duration-300 ${selectedDisease?.name === disease.name ? 'rotate-45' : ''}`}>
