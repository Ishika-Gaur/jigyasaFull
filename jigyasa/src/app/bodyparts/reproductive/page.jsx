  ...
  const diseases = [
    {
      ...
      description:
        "Bacterial infection affecting kidneys, bladder, or urethra."
    },
    {
      name: "Kidney Stones",
      description:
        "Hard mineral deposits treated using URSL, RIRS & PCNL."
    },
    {
      name: "Prostate Enlargement (BPH)",
      description:
        "Non-cancerous prostate enlargement treated medically or with TURP."
    },
    {
      name: "Bladder Disorders & Stones",
      description:
        "Bladder stones, tumors & infections managed with cystoscopy."
    },
    {
      name: "Male Infertility & Erectile Dysfunction",
      description:
        "Evaluation & treatment with medical and surgical options."
    },
    {
      name: "Urethral Stricture & Reconstruction",
      description:
        "Urethral narrowing treated with OIU or urethroplasty."
    }
  ];
      ...
      <div className="relative w-full h-[75vh] min-h-[550px] flex items-center justify-center overflow-hidden bg-cover bg-center bg-no-repeat" 
        ...
        <div className="relative z-10 text-center max-w-[1000px] px-8 animate-[slideInUp_1s_ease-out]">
          ...
          <h1 className="font-['Playfair_Display'] text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight mb-5 drop-shadow-[2px_2px_8px_rgba(0,0,0,0.3)] animate-[fadeIn_1s_ease-out_0.2s_backwards]">
            Urology & Reproductive Health Department
          </h1>
          ...
          <p className="text-lg md:text-xl text-white/95 mb-8 max-w-[800px] mx-auto leading-relaxed drop-shadow-[1px_1px_4px_rgba(0,0,0,0.3)] animate-[fadeIn_1s_ease-out_0.4s_backwards]">
            Advanced care for urinary & male reproductive disorders
          </p>
      ...
      <div className="max-w-[1400px] mx-auto my-24 px-6 sm:px-8 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative animate-[slideInRight_1s_ease-out]">
            <img
              src="https://i.pinimg.com/1200x/d4/7c/61/d47c61ccbe6b8d7ee00e7a5dab3c6005.jpg"
