  ...
  const diseases = [
    {
      ...
      description:
        "Comprehensive diabetes care including lifestyle modification, insulin therapy, and complication prevention."
    },
    {
      name: "Thyroid Disorders",
      description:
        "Diagnosis and treatment of hypothyroidism, hyperthyroidism, thyroid nodules, and autoimmune thyroid diseases."
    },
    {
      name: "PCOS",
      description:
        "Management of PCOS focusing on hormonal balance, fertility support, and metabolic control."
    },
    {
      name: "Osteoporosis",
      description:
        "Bone density assessment and fracture prevention with calcium, vitamin D, and advanced medications."
    },
    {
      name: "Hormonal Disorders",
      description:
        "Management of pituitary, adrenal, and metabolic syndrome disorders."
    }
  ];
    ...
    <>
      ...
      <div className="relative w-full h-[75vh] min-h-[550px] flex items-center justify-center overflow-hidden md:h-[65vh] md:min-h-[500px] sm:h-[60vh] sm:min-h-[450px] xs:h-[55vh] xs:min-h-[400px]">
        ...
        <div className="relative z-10 text-center max-w-[1000px] px-8 animate-[slideInUp_1s_ease-out]">
          ...
          <h1 className="font-['Playfair_Display'] text-5xl font-bold text-white leading-tight mb-5 [text-shadow:2px_2px_8px_rgba(0,0,0,0.3)] animate-[fadeIn_1s_ease-out_0.2s_backwards] md:text-[2.8rem] sm:text-[2.2rem] xs:text-[1.8rem] [360px]:text-2xl">
            Endocrinology & Hormone Care Centre
          </h1>
          ...
          <p className="text-xl text-white/95 mb-8 max-w-[800px] mx-auto leading-relaxed [text-shadow:1px_1px_4px_rgba(0,0,0,0.3)] animate-[fadeIn_1s_ease-out_0.4s_backwards] md:text-[1.1rem] sm:text-base xs:text-[0.9rem]">
            Specialized care for diabetes, thyroid & hormonal disorders
          </p>
      ...
      <div className="max-w-[1400px] mx-auto my-24 px-12 sm:px-6 sm:my-15 xs:px-4">
        <div className="text-center mb-15 animate-[fadeInUp_0.8s_ease-out]">
          <h1 className="font-['Playfair_Display'] text-5xl font-bold text-slate-800 mb-4 relative md:text-[2.5rem] sm:text-[2rem] xs:text-[1.7rem] [360px]:text-2xl">
            About Endocrinology Department
          </h1>
          ...
          {[
            {
              icon: "💉",
              title: "Diabetes Care",
              items: ["Blood Sugar Monitoring", "Insulin Management", "Lifestyle Counseling", "Complication Screening"]
            },
            {
              icon: "🦋",
              title: "Thyroid Services",
              items: ["TSH Testing", "Ultrasound Scans", "Medication Therapy", "Nodule Evaluation"]
            },
            {
              icon: "🧬",
              title: "Hormone Therapy",
              items: ["PCOS Treatment", "Hormone Replacement", "Fertility Support", "Metabolic Testing"]
            },
            {
              icon: "💊",
              title: "Bone Health",
              items: ["DEXA Scans", "Osteoporosis Care", "Calcium Therapy", "Fracture Prevention"]
            }
          ].map((service, index) => (
            <div
              key={index}
      ...
      <div className="max-w-[1400px] mx-auto mt-24 mb-15 px-12 sm:px-6 sm:mt-15 xs:px-4">
        ...
        <p className="text-center text-lg text-slate-500 max-w-[700px] mx-auto mb-5 leading-relaxed xs:text-base">
          Expert treatment for a wide range of endocrine and metabolic disorders
        </p>
