  ...
  const diseases = [
    {
      name: "Cataract",
      description:
        "Clouding of the eye lens treated with advanced cataract surgery."
    },
    {
      name: "Glaucoma",
      description:
        "Damage to optic nerve due to high eye pressure managed with medication or surgery."
    },
    {
      name: "Diabetic Retinopathy",
      description:
        "Diabetes-related retinal damage treated with laser and injections."
    },
    {
      name: "Macular Degeneration",
      description:
        "Age-related vision loss managed with injections and monitoring."
    },
    {
      name: "Eye Infections & Conjunctivitis",
      description:
        "Redness and infection treated with targeted medications."
    }
  ];
    ...
    <>
      ...
      <div className="relative w-full h-[75vh] min-h-[550px] flex items-center justify-center overflow-hidden md:h-[65vh] md:min-h-[500px] sm:h-[60vh] sm:min-h-[450px] xs:h-[55vh] xs:min-h-[400px]">
        ...
        <div className="relative z-10 text-center max-w-[1000px] px-8 animate-[slideInUp_1s_ease-out]">
          ...
          <p className="text-xl text-white/95 mb-8 max-w-[800px] mx-auto leading-relaxed [text-shadow:1px_1px_4px_rgba(0,0,0,0.3)] animate-[fadeIn_1s_ease-out_0.4s_backwards] md:text-[1.1rem] sm:text-base xs:text-[0.9rem]">
            Comprehensive eye care for lifelong vision health
          </p>
          ...
          {[
            {
              ...
              items: ["Vision Testing", "Eye Pressure Check", "Retinal Imaging", "Visual Field Test"]
            },
            {
              icon: "⚕️",
              title: "Medical Treatment",
              items: ["Cataract Surgery", "Glaucoma Care", "Laser Therapy", "Injection Treatment"]
            },
            {
              icon: "👓",
              title: "Optical Services",
              items: ["Prescription Glasses", "Contact Lenses", "Low Vision Aids", "Protective Eyewear"]
            },
            {
              icon: "🩺",
              title: "Specialized Care",
              items: ["Retinal Surgery", "Corneal Treatment", "Pediatric Eye Care", "Emergency Services"]
            }
          ].map((service, index) => (
            <div
              key={index}
      ...
      <div className="max-w-[1400px] mx-auto mt-24 mb-15 px-12 sm:px-6 sm:mt-15 xs:px-4">
        ...
        <p className="text-center text-lg text-slate-500 max-w-[700px] mx-auto mb-5 leading-relaxed xs:text-base">
          Expert treatment for a comprehensive range of eye conditions and vision disorders
        </p>
