  ...
  const conditions = [
    {
      name: "Depression",
      description:
        "Persistent sadness, loss of interest, and low energy affecting daily life."
    },
    {
      name: "Anxiety Disorders",
      description:
        "Generalized anxiety, panic disorder, phobias, and social anxiety."
    },
    {
    ...
    },
    {
      ...
      description:
        "Disorders affecting thinking, perception, and behavior."
    },
    {
      name: "Obsessive-Compulsive Disorder (OCD)",
      description:
        "Intrusive thoughts and repetitive behaviors treated with CBT."
    },
    {
      name: "Addiction & Substance Abuse",
      description:
        "Alcohol and substance dependence treated with de-addiction programs."
    }
  ];
      ...
      <div className="relative w-full h-[75vh] min-h-[550px] bg-[url('https://i.pinimg.com/1200x/79/ca/cd/79cacd36b206e0e26204d7a48e4f8dc1.jpg')] bg-cover bg-center bg-no-repeat flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-[2] text-center max-w-[1000px] px-8 animate-[slideInUp_1s_ease-out]">
          ...
          <p className="text-xl text-white/95 mb-8 max-w-[800px] mx-auto leading-[1.7] drop-shadow-[1px_1px_4px_rgba(0,0,0,0.3)] animate-[fadeIn_1s_ease-out_0.4s_backwards]">
            Compassionate, confidential & evidence-based mental health services
          </p>
          <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            <p className="text-lg leading-[1.9] text-slate-600 mb-[1.5rem] text-justify animate-[fadeIn_0.8s_ease-out_0.1s_backwards]">
              The Psychiatry Department at <strong className="font-semibold">Jigyasa Hospital</strong>
          ...
          <div className="relative animate-[slideInRight_1s_ease-out]">
            <img
              src="https://i.pinimg.com/1200x/55/5c/d9/555cd982d8a8f84db7bda9596c6fd042.jpg"
