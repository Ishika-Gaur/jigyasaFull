  ...
  const diseases = [
    {
      ...
      description:
        "Surgical correction to restore feeding, speech, and facial symmetry."
    },
    {
      name: "Burn Reconstruction",
      description:
        "Release of burn scars using grafts and flaps to restore mobility."
    },
    {
      name: "Hand Trauma & Microsurgery",
      description:
        "Microsurgical repair of tendons, nerves, and bones."
    },
    {
      name: "Breast Reconstruction",
      description:
        "Post-mastectomy reconstruction using implants or tissue flaps."
    },
    {
      name: "Facial Trauma",
      description:
        "Repair of fractures and craniofacial deformities."
    },
    {
      name: "Cosmetic Surgery",
      description:
        "Rhinoplasty, liposuction, breast surgery, and aesthetic procedures."
    }
  ];
    ...
    <>
      ...
      <div className="max-w-[1400px] mx-auto my-24 px-12 sm:px-6 sm:my-15 xs:px-4">
        <div className="text-center mb-15 animate-[fadeInUp_0.8s_ease-out]">
          <h1 className="font-['Playfair_Display'] text-5xl font-bold text-slate-800 mb-4 relative md:text-[2.5rem] sm:text-[2rem] xs:text-[1.7rem] [360px]:text-2xl">
            About Plastic Surgery Department
          </h1>
          ...
          {[
            {
              ...
              items: ["Cleft Repair", "Burn Reconstruction", "Trauma Repair", "Cancer Reconstruction"]
            },
            {
              icon: "✋",
              title: "Hand & Microsurgery",
              items: ["Tendon Repair", "Nerve Surgery", "Replantation", "Congenital Defects"]
            },
            {
              icon: "💆",
              title: "Cosmetic Procedures",
              items: ["Rhinoplasty", "Liposuction", "Breast Surgery", "Face Lifts"]
            },
            {
              icon: "🩹",
              title: "Specialized Care",
              items: ["Scar Revision", "Skin Grafts", "Flap Surgery", "Laser Treatment"]
            }
          ].map((service, index) => (
            <div
              key={index}
      ...
      <div className="max-w-[1400px] mx-auto mt-24 mb-15 px-12 sm:px-6 sm:mt-15 xs:px-4">
        ...
        <p className="text-center text-lg text-slate-500 max-w-[700px] mx-auto mb-5 leading-relaxed xs:text-base">
          Expert reconstructive and cosmetic surgical solutions for comprehensive care
        </p>
