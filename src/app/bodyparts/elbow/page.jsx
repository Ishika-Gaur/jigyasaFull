  ...
  const diseases = [
    {
      ...
      description:
        "Fractures of the elbow joint due to falls or trauma. Managed with casting or surgical fixation."
    },
    {
      name: "Tennis Elbow",
      description:
        "Overuse injury causing pain on the outer side of the elbow. Treated with medication and physiotherapy."
    },
    {
      name: "Golfer's Elbow",
      description:
        "Inflammation of inner elbow tendons leading to pain and weakness."
    },
    {
      name: "Elbow Dislocation",
      description:
        "Displacement of elbow joint bones treated with emergency reduction and rehabilitation."
    },
    {
      name: "Nerve Compression",
      description:
        "Cubital tunnel syndrome and stiffness managed with medical care or surgery."
    }
  ];
    ...
    <>
      ...
      <div className="relative w-full h-[75vh] min-h-[550px] flex items-center justify-center overflow-hidden md:h-[65vh] md:min-h-[500px] sm:h-[60vh] sm:min-h-[450px] xs:h-[55vh] xs:min-h-[400px]">
        ...
        <div className="relative z-10 text-center max-w-[1000px] px-8 animate-[slideInUp_1s_ease-out]">
          ...
          <h1 className="font-['Playfair_Display'] text-5xl font-bold text-white leading-tight mb-5 [text-shadow:2px_2px_8px_rgba(0,0,0,0.3)] animate-[fadeIn_1s_ease-out_0.2s_backwards] md:text-[2.8rem] sm:text-[2.2rem] xs:text-[1.8rem] [360px]:text-2xl">
            Elbow Care & Orthopedic Services
          </h1>
          ...
          <p className="text-xl text-white/95 mb-8 max-w-[800px] mx-auto leading-relaxed [text-shadow:1px_1px_4px_rgba(0,0,0,0.3)] animate-[fadeIn_1s_ease-out_0.4s_backwards] md:text-[1.1rem] sm:text-base xs:text-[0.9rem]">
            Specialized treatment for elbow injuries and joint disorders
          </p>
          ...
          {[
            {
              icon: "🔍",
              title: "Diagnostics",
              items: ["X-Ray & MRI", "Clinical Examination", "Nerve Studies", "Joint Assessment"]
            },
            {
              icon: "💊",
              title: "Medical Treatment",
              items: ["Pain Management", "Physiotherapy", "Injection Therapy", "Rehabilitation"]
            },
            {
              icon: "🏥",
              title: "Surgical Care",
              items: ["Fracture Fixation", "Arthroscopy", "Joint Replacement", "Nerve Release"]
            },
            {
              icon: "🎯",
              title: "Recovery Support",
              items: ["Post-Op Care", "Exercise Programs", "Follow-up Monitoring", "Prevention Tips"]
            }
          ].map((service, index) => (
            <div
              key={index}
      ...
      <div className="max-w-[1400px] mx-auto mt-24 mb-15 px-12 sm:px-6 sm:mt-15 xs:px-4">
        ...
        <p className="text-center text-lg text-slate-500 max-w-[700px] mx-auto mb-5 leading-relaxed xs:text-base">
          Comprehensive treatment for all elbow-related conditions and injuries
        </p>
