  ...
  const diseases = [
    {
      ...
      description:
        "Routine checkups, vaccinations, health screenings, and lifestyle counseling for all ages."
    },
    {
      name: "Chronic Disease Management",
      description:
        "Long-term care for diabetes, hypertension, asthma, arthritis, and other chronic conditions."
    },
    {
      name: "Acute Illness Care",
      description:
        "Treatment for fever, cold, flu, infections, allergies, and minor injuries."
    },
    {
      name: "Pediatric & Adolescent Care",
      description:
        "Growth monitoring, immunizations, developmental assessments, and childhood illness management."
    },
    {
      name: "Women's Health",
      description:
        "Reproductive health, prenatal care, menopause management, and preventive screenings."
    },
    {
      name: "Geriatric Care",
      description:
        "Comprehensive care for elderly patients including mobility issues, medication management, and age-related conditions."
    },
    {
      name: "Mental Health Support",
      description:
        "Screening for depression, anxiety, stress management, and referrals to specialists when needed."
    }
  ];
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-[1000px] px-8 animate-[slideInUp_1s_ease-out]">
          ...
          <p className="text-xl text-white/95 mb-8 max-w-[800px] mx-auto leading-relaxed drop-shadow-[1px_1px_4px_rgba(0,0,0,0.3)] animate-[fadeIn_1s_ease-out_0.4s_backwards] max-md:text-base max-sm:text-[0.9rem]">
            Comprehensive primary care for patients of all ages and health needs
          </p>
      ...
      <div className="max-w-[1400px] mx-auto my-[100px] px-12 max-md:px-6 max-md:my-[60px] max-sm:px-4">
        <div className="text-center mb-[60px] animate-[fadeInUp_0.8s_ease-out]">
          <h1 className="font-['Playfair_Display'] text-5xl font-bold text-slate-800 mb-4 relative max-md:text-[2rem] max-sm:text-[1.7rem]">
            About Family Medicine Department
          </h1>
        ...
        <div className="grid grid-cols-2 gap-16 items-center max-lg:grid-cols-1 max-lg:gap-12">
          <div className="relative">
            <p className="text-[1.05rem] leading-relaxed text-slate-600 mb-6 text-justify animate-[fadeIn_0.8s_ease-out_0.1s_backwards] max-sm:text-[0.95rem]">
              The Family Medicine Department at <strong>Jigyasa Hospital</strong> serves
              as your first point of contact for comprehensive healthcare. Our
              family physicians provide continuous, patient-centered care for
              individuals and families across all ages, from newborns to seniors.
            </p>
            <p className="text-[1.05rem] leading-relaxed text-slate-600 mb-0 text-justify animate-[fadeIn_0.8s_ease-out_0.2s_backwards] max-sm:text-[0.95rem]">
              We focus on preventive care, early diagnosis, and management of
              both acute and chronic conditions. Our holistic approach considers
              physical, mental, and social aspects of health, building long-term
              relationships with patients to ensure continuity of care and better
          ...
          <div className="relative animate-[slideInRight_1s_ease-out] max-lg:max-w-[500px] max-lg:mx-auto">
            <img
              src="https://i.pinimg.com/1200x/c7/c2/0c/c7c20ce0fa6f1a58cb877a4fd52fba99.jpg"
              alt="Family Medicine"
