  ...
  const diseases = [
    {
      ...
      description:
        "Chronic acidity and heartburn managed with medication and lifestyle modification."
    },
    {
      name: "Gastritis & Peptic Ulcer",
      description:
        "Inflammation of stomach lining treated with medication and endoscopy."
    },
    {
      name: "Irritable Bowel Syndrome (IBS)",
      description:
        "Functional bowel disorder treated with diet, stress control and medication."
    },
    {
      name: "Inflammatory Bowel Disease (IBD)",
      description:
        "Crohn's & ulcerative colitis managed with long-term therapy."
    },
    {
      name: "Liver Disorders",
      description:
        "Fatty liver, hepatitis & cirrhosis treated with medical management."
    },
    {
      name: "Pancreatic & Gallbladder Disorders",
      description:
        "Pancreatitis & gallstones treated with advanced procedures."
    },
    {
      name: "GI Bleeding & Anemia",
      description:
        "Diagnosed and treated using therapeutic endoscopy."
    }
  ];
      ...
      <div className="relative w-full h-[75vh] min-h-[550px] flex items-center justify-center overflow-hidden bg-cover bg-center bg-no-repeat" 
        ...
        <div className="relative z-10 text-center max-w-[1000px] px-8 animate-[slideInUp_1s_ease-out]">
          ...
          <p className="text-lg md:text-xl text-white/95 mb-8 max-w-[800px] mx-auto leading-relaxed drop-shadow-[1px_1px_4px_rgba(0,0,0,0.3)] animate-[fadeIn_1s_ease-out_0.4s_backwards]">
            Expert care for digestive, liver & bowel disorders
          </p>
