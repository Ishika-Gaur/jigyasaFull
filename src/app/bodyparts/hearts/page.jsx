  ...
  const conditions = [
    {
      ...
      description:
        "Narrowing of coronary arteries treated with medications, angioplasty, stenting, or bypass surgery."
    },
    {
      name: "Heart Rhythm Disorders",
      description:
        "Arrhythmias managed with medication, pacemakers, ICDs, and ablation."
    },
    {
      name: "Heart Valve Diseases",
      description:
        "Valve repair or replacement for mitral and aortic valve disorders."
    },
    {
      name: "Heart Failure",
      description:
        "Comprehensive heart failure management including device therapy and rehabilitation."
    },
    {
      name: "Congenital Heart Disease",
      description:
        "Structural heart defects treated through catheter-based procedures or surgery."
    },
    {
      name: "Hypertension",
      description:
        "High blood pressure management with preventive cardiology programs."
    }
  ];
      ...
      <div className="relative w-full h-[75vh] min-h-[550px] bg-[url('https://i.pinimg.com/1200x/79/ca/cd/79cacd36b206e0e26204d7a48e4f8dc1.jpg')] bg-cover bg-center bg-no-repeat flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-[2] text-center max-w-[1000px] px-8 animate-[slideInUp_1s_ease-out]">
          ...
          <p className="text-xl text-white/95 mb-8 max-w-[800px] mx-auto leading-[1.7] drop-shadow-[1px_1px_4px_rgba(0,0,0,0.3)] animate-[fadeIn_1s_ease-out_0.4s_backwards]">
            Advanced heart care under one roof
          </p>
          <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            <p className="text-lg leading-[1.9] text-slate-600 mb-[1.5rem] text-justify animate-[fadeIn_0.8s_ease-out_0.1s_backwards]">
              The Cardiology Department at <strong className="font-semibold">Jigyasa Hospital</strong> is a
          ...
          <div className="relative animate-[slideInRight_1s_ease-out]">
            <img
              src="https://i.pinimg.com/1200x/6b/c2/97/6bc2975c6684e1f9117f711cfc2e57a7.jpg"
      ...
      <div className="max-w-[1400px] mx-auto mt-[100px] mb-[60px] px-12">
        ...
        <div className="space-y-4">
          {conditions.map((condition, index) => (
            <div key={index} className="animate-[fadeInUp_0.6s_ease-out_backwards] [&:nth-child(1)]:animate-delay-[0.1s] [&:nth-child(2)]:animate-delay-[0.2s] [&:nth-child(3)]:animate-delay-[0.3s] [&:nth-child(4)]:animate-delay-[0.4s] [&:nth-child(5)]:animate-delay-[0.5s] [&:nth-child(6)]:animate-delay-[0.6s]">
              <div
