...
export default function OralMaxillofacial() {
  ...
  const conditions = [
    {
      ...
      description:
        "Wisdom teeth trapped beneath gums causing pain and infection. Managed with surgical extraction."
    },
    {
      name: "Facial Fractures & Trauma",
      description:
        "Jaw and facial fractures treated with precise surgical fixation."
    },
    {
      name: "TMJ Disorders",
      description:
        "Jaw joint disorders managed with splints, medication and surgery."
    },
    {
      name: "Jaw Deformities",
      description:
        "Orthognathic surgery to correct jaw alignment and bite."
    },
    {
      name: "Cleft Lip & Palate",
      description:
        "Staged surgical correction to restore speech and facial balance."
    },
    {
      name: "Oral Cysts & Tumors",
      description:
        "Biopsy and surgical excision of oral growths."
    },
    {
      name: "Dental Implant Surgery",
      description:
        "Advanced implants, bone grafting and sinus lift procedures."
    },
    {
      name: "Salivary Gland Disorders",
      description:
        "Treatment of gland stones, infections and tumors."
    }
  ];
      ...
      <div className="relative w-full h-[75vh] min-h-[550px] bg-[url('https://i.pinimg.com/1200x/79/ca/cd/79cacd36b206e0e26204d7a48e4f8dc1.jpg')] bg-cover bg-center bg-no-repeat flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-[2] text-center max-w-[1000px] px-8 animate-[slideInUp_1s_ease-out]">
          ...
          <p className="text-xl text-white/95 mb-8 max-w-[800px] mx-auto leading-[1.7] drop-shadow-[1px_1px_4px_rgba(0,0,0,0.3)] animate-[fadeIn_1s_ease-out_0.4s_backwards]">
            Advanced surgical care for face, jaw & dental conditions
          </p>
          <button
      ...
      <div className="max-w-[1400px] mx-auto mt-[100px] px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative animate-[slideInRight_1s_ease-out]">
            <img
              src="https://i.pinimg.com/1200x/fa/f7/23/faf7238b4c0fb222c0886e8315c6184e.jpg"
      ...
      <div className="max-w-[1400px] mx-auto mt-[100px] mb-[60px] px-12">
        ...
        <div className="space-y-4">
          {conditions.map((condition, index) => (
            <div 
              key={index} 
              className="animate-[fadeInUp_0.6s_ease-out_backwards] [&:nth-child(1)]:delay-[0.1s] [&:nth-child(2)]:delay-[0.2s] [&:nth-child(3)]:delay-[0.3s] [&:nth-child(4)]:delay-[0.4s] [&:nth-child(5)]:delay-[0.5s] [&:nth-child(6)]:delay-[0.6s] [&:nth-child(7)]:delay-[0.7s] [&:nth-child(8)]:delay-[0.8s]"
            >
              <div
