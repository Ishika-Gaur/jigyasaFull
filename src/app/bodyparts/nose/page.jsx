  ...
  const conditions = [
    {
      name: "Sinusitis",
      description:
        "Inflammation of sinus cavities causing facial pain and nasal blockage."
    },
    {
      name: "Allergic Rhinitis",
      description:
        "Nasal allergy causing sneezing, itching and congestion."
    },
    {
      name: "Deviated Nasal Septum (DNS)",
      description:
        "Structural nasal deviation corrected with septoplasty."
    },
    {
      name: "Nasal Polyps",
      description:
        "Non-cancerous growths treated with medication or surgery."
    },
    {
      name: "Epistaxis (Nose Bleeding)",
      description:
        "Recurrent nosebleeds treated with medical care or cauterization."
    },
    {
      name: "Nasal Trauma & Fractures",
      description:
        "Injury-related nasal fractures managed with realignment or surgery."
    }
  ];
      ...
      <div className="relative w-full h-[75vh] min-h-[550px] bg-[url('https://i.pinimg.com/1200x/79/ca/cd/79cacd36b206e0e26204d7a48e4f8dc1.jpg')] bg-cover bg-center bg-no-repeat flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-[2] text-center max-w-[1000px] px-8 animate-[slideInUp_1s_ease-out]">
          ...
          <p className="text-xl text-white/95 mb-8 max-w-[800px] mx-auto leading-[1.7] drop-shadow-[1px_1px_4px_rgba(0,0,0,0.3)] animate-[fadeIn_1s_ease-out_0.4s_backwards]">
            Advanced treatment for nasal & sinus disorders
          </p>
          <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            <p className="text-lg leading-[1.9] text-slate-600 mb-[1.5rem] text-justify animate-[fadeIn_0.8s_ease-out_0.1s_backwards]">
              The Nose & Sinus Care Unit at <strong className="font-semibold">Jigyasa Hospital</strong>
