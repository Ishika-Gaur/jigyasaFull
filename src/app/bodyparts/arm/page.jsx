  ...
  const diseases = [
    {
      name: "Arm Fractures",
      description:
        "Fractures of the shoulder, arm, elbow, wrist or hand treated with casting or surgical fixation."
    },
    {
      name: "Shoulder Disorders",
      description:
        "Frozen shoulder, rotator cuff injuries and instability managed with therapy or surgery."
    },
    {
      name: "Tennis Elbow & Golfer's Elbow",
      description:
        "Overuse injuries causing pain and weakness treated with rehabilitation programs."
    },
    {
      name: "Carpal Tunnel Syndrome",
      description:
        "Median nerve compression causing numbness and weakness managed with splints or surgery."
    },
    {
      name: "Nerve & Tendon Injuries",
      description:
        "Damage to nerves or tendons treated with microsurgical repair and rehab."
    }
  ];
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-[1000px] px-8 animate-[slideInUp_1s_ease-out]">
          ...
          <p className="text-xl text-white/95 mb-8 max-w-[800px] mx-auto leading-relaxed drop-shadow-[1px_1px_4px_rgba(0,0,0,0.3)] animate-[fadeIn_1s_ease-out_0.4s_backwards] max-md:text-base max-sm:text-[0.9rem]">
            Advanced diagnosis and treatment for arm and hand conditions
          </p>
